...
function Header({ currentView, onNavigate, userProfile }) {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-start justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        <Header currentView={currentView} onNavigate={setCurrentView} userProfile={userProfile} />

        {currentView === "home" && <HomeView onNavigate={setCurrentView} stats={stats} />}
        {currentView === "profilo" && <ProfiloAzienda userProfile={userProfile} setUserProfile={setUserProfile} onNavigate={setCurrentView} />}
